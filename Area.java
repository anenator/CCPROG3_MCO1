...
public abstract class Area {
    ...
    protected View view;  // Add this line
    ...
    public void checkEncounter(Inventory userInventory) {
        ...
        if (rand.nextInt(10) < 4) {
            ...
            if (enemyCreature != null) {
                ...
                // Call the encounterScreen() method before entering BattlePhase
                view.encounterScreen(enemyCreature.getCreatureName(), enemyCreature.getCreatureType(), 
                enemyCreature.getCreatureEvolutionLevel(), enemyCreature.getCurrentHealth(), 
                userInventory.activeCreature.getCreatureName(), 
                userInventory.activeCreature.getCreatureEvolutionLevel(),
                userInventory.activeCreature.getCreatureType());
            
            } else {
                System.out.println("No enemy creature encountered.");
            }
        }
    }
