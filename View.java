...
public class View {
    // Add a vertical seperator at the right side of the main frame with icons
    JSeparator toolbarSeparator = new JSeparator(SwingConstants.VERTICAL);
    ...
    public View() {
        ...
        public void encounterScreen(String name, String type, int evolutionLevel, int health, String aCName, int aCEvolutionLevel, String aCType) {
        ...
        labelEnemyHealth.setText("Health: " + health);
        ...
        // Update the active creature's name, EL, and type in the toolbar
        labelActiveCreatureName.setText("Active Creature: " + aCName);
        labelActiveCreatureEL.setText("EL: " + aCEvolutionLevel);
        labelActiveCreatureType.setText("Type: " + aCType);

        // Add the labels to the toolbar
        encounterToolBar.add(labelActiveCreatureName);
        encounterToolBar.add(labelActiveCreatureEL);
        encounterToolBar.add(labelActiveCreatureType);
        encounterToolBar.add(toolbarSeparator);
    ...
    public void initializeArea1Panel() {
        ...
        for (int i = 0; i < 5; i++) {
            ...
            area1Boxes[i] = whiteBox1; // Store the JPanel object in the array
        }
        area1Boxes[0].setBackground(Color.BLUE);
    ...
    public void closeEncounterScreen() {
    ...
    public JButton getButtonExploreArea() {
        return buttonExploreArea;
    }
    
    public JButton getButtonEvolveCreature() {
        return buttonEvolveCreature;
    }
    ...
    //Encounter Button Getters

    public JButton getButtonAttack() {
        return buttonAttack;
    }

    public JButton getButtonSwap() {
        return buttonSwap;
    }

    public JButton getButtonCatch() {
        return buttonCatch;
    }
